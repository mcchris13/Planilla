      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-blue">
            ...
            <a href="employee.php" class="small-box-footer">Ver</a>
          </div>
        </div>
        <!-- box -->
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-blue">
            <div class="inner">
              ...
              <p>Empleados puntuales</p>
            </div>
            <div class="icon">
              <i class="ion ion-pie-graph"></i>
            </div>
            <a href="attendance.php" class="small-box-footer">Ver</a>
          </div>
        </div>
        <!-- box -->
        <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Gráfico de asistencia mensual</h3>
