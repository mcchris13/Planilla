    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                  	<label for="hours" class="col-sm-3 control-label">N° Horas</label>
          	...
          	<div class="modal-footer">
            	<button type="button" class="btn btn-default btn-flat pull-center" data-dismiss="modal"><i class="fa fa-close"></i> Cerrar</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="hours_edit" class="col-sm-3 control-label">N° Horas</label>

                    <div class="col-sm-9">
                      <input type="number" class="form-control" id="hours_edit" name="hours">
                    </div>
                </div>
