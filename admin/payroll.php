          ...
          <div class="box">
            <div class="box-header with-border">
                ...
                <form method="POST" class="form-inline" id="payForm">
                  <div class="pull-left">
                  <button type="button" class="btn btn-success btn-sm btn-flat" id="payroll"><span class="glyphicon glyphicon-print"></span> Planilla</button>
                  <button type="button" class="btn btn-primary btn-sm btn-flat" id="payslip"><span class="glyphicon glyphicon-print"></span> Recibo</button>
                  </div>
