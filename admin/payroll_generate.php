<?php
    ...
    $pdf->SetTitle('Planilla: '.$from_title.' - '.$to_title);  
    ...
    $content = '';  
    $content .= '
      	<h2 align="center">SAM I&C - Planilla</h2>
      	<h3 align="center">'.$from_title." - ".$to_title.'</h4>
      	<table border="1" cellspacing="0" cellpadding="3">  
           	<tr>
		   		<th width="15%" align="center"><b>ID Empleado</b></th>
           		<th width="55%" align="center"><b>Nombre Empleado</b></th>
				<th width="30%" align="center"><b>Suedo Neto</b></th> 
          	</tr>  
      ';  
