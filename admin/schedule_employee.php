        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="schedule_print.php" class="btn btn-primary btn-sm btn-flat"><span class="glyphicon glyphicon-print"></span> Imprimir</a>
            </div>
            <div class="box-body">
                    ...
                    while($row = $query->fetch_assoc()){
                      echo "
                        <tr>
                          ...
                          <td>
                            <button class='btn btn-success btn-sm edit btn-flat' data-id='".$row['empid']."'><i class='fa fa-edit'></i> </button>
                          </td>
                        </tr>
                      ";
                    }
